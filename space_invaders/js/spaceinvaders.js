...
WelcomeState.prototype.enter = function(game) {
    ...
    game.ship_img = new Image();
    game.ship_img.src = 'images/not_bad_1.png';
    game.invader_img = new Image();
    game.invader_img.src = 'images/smart_1.png';
...
PlayState.prototype.draw = function(game, dt, ctx) {
    ...
    ctx.drawImage(game.ship_img, this.ship.x - (this.ship.width / 2), this.ship.y - (this.ship.height / 2));

    //  Draw invaders.
    ctx.fillStyle = '#006600';
    for(var i=0; i<this.invaders.length; i++) {
        var invader = this.invaders[i];
        ctx.drawImage(game.invader_img, invader.x - invader.width/2, invader.y - invader.height/2);
    }
